    ...
    <div class="con_div">
      ...
      <div class="con_div_text left">
        <div class="con_div_text01 left">
          ...
          <div class="left text01_div">
            <p>选取样点个数</p>
            <p style="cursor:poiner;" class="sky">60</p>
          </div>
        </div>
        <div class="con_div_text01 right">
          <img src="../../assets/image/info_5.png" class="left text01_img" />
          <div class="left text01_div">
            <p>勘察样点个数</p>
            <p style="cursor:poiner;" class="sky">3</p>
          </div>
        </div>
      </div>
      <div class="con_div_text left">
        <div class="con_div_text01 left">
          ...
          <div class="left text01_div">
            <p>一级样点个数</p>
            <p style="cursor:poiner;" class="org">10</p>
          </div>
        </div>
        <div class="con_div_text01 right">
          <img src="../../assets/image/info_5.png" class="left text01_img" />
          <div class="left text01_div">
            <p>待处理个数</p>
            <p style="cursor:poiner;" class="org">7</p>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  mounted: function() {
    ...
    //加载地球
    var viewer = new Cesium.Viewer("viewer2", {
    ...
    shpData1.features.forEach(function(v) {
      ...
      // var positions = new Cesium.fromArray(Cesium.Cartesian3.fromDegreesArray(JSON.parse("[" + v.geometry.rings[0].toString() + "]")));

      // if (v.geometry.rings.length > 1) {
      // positions = new Cesium.fromArray(Cesium.Cartesian3.fromDegreesArray(JSON.parse("[" + v.geometry.rings[0].toString() + "]")),
      // [new Cesium.fromArray(Cesium.Cartesian3.fromDegreesArray(JSON.parse("[" + v.geometry.rings[1].toString() + "]")))]);}
  ...
  methods: {
    drawColumnChart() {
      ...
      this.chartColumn.setOption({
        ...
        // 				var colorlist = ['#DA251D', '#E67716', '#FBC300'];
